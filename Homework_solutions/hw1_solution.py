...
def min_rotated(rotated, size):
    ...
    #Every iteration, determine if the minimum val will be on the left or right subarray
    ...
    #When the loop breaks, start and end point at the same element, and the subarray is just one element
